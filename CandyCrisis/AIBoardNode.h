...
public:
	...
	AIBoardNode(AIBoardNode* parentNode, MovementDirection movementGeneratedBy, int diff, int eVertLocation, int eHorizLocation, long long int boardState);
	AIBoardNode(AIBoardNode* parentNode, MovementDirection movementGeneratedBy, int eVertLocation, int eHorizLocation, long long int boardState) : AIBoardNode(parentNode, movementGeneratedBy, parentNode->getDifficulty(), eVertLocation, eHorizLocation, boardState) {}
	...
	int weightBasedOnDifficulty(int cellValue);
